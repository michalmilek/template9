...
const ArrowBtn = ({
  ...
  const ArrowButton = styled.button`
    ...
    font-size: ${fontSize === "md" ? ({ theme }) => theme.fontSize.md : fontSize === "sm" ? ({ theme }) => theme.fontSize.sm : fontSize === "lg" ? ({ theme }) => theme.fontSize.lg : fontSize === "xl" ? ({ theme }) => theme.fontSize.xl : fontSize === "2xl" ? ({ theme }) => theme.fontSize["2xl"] : "16px" };
    line-height: 28px;
    cursor: pointer;
