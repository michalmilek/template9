...
export function getBackground(color: buttonColor | undefined) {
  switch (color) {
    case "buttonYellow":
      return ({ theme }: { theme: ThemeInterface }) =>
        theme.colors.buttonYellow;
    ...
    case "black":
      return ({ theme }: { theme: ThemeInterface }) => theme.colors.black;
    case "RoyalBlue":
      return ({ theme }: { theme: ThemeInterface }) => theme.colors.RoyalBlue;
    case "transparent":
      return "transparent";
    default:
      return "transparent";
...
export function getFontSize(fontSize: fontSize) {
  switch (fontSize) {
    ...
    case "ms":
      return ({ theme }: { theme: ThemeInterface }) => theme.fontSize.ms;
    default:
      return "16px";
  }
}
...
export function getBorderRadius(borderRadius: borderRadius | undefined) {
  switch (borderRadius) {
    ...
    case "full":
      return ({ theme }: { theme: ThemeInterface }) => theme.borderRadius.full;
    default:
      return 0;
  }
}
